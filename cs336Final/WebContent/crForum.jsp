...
String str = "SELECT f.idforum, f.cr_email, f.customer_email, f.subject, f.question, f.reply, f.datePosted FROM forum as f;";
ResultSet result = stmt.executeQuery(str);
while(result.next()){
int idforum = result.getInt("f.idforum");
...
if(reply ==null){
out.print("<th> <a href='answer.jsp?idforum=" + idforum + "'>Answer this question!</th>");
}
else{
